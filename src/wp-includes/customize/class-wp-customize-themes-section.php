...
">
        ...
        if (count($this->controls) > 0) {
            ?>
					<button type="button" class="button change-theme" tabindex="0"><?php 
            _ex('Change', 'theme');
            ?>
</button>
				<?php 
        ...
        ?>
					<button type="button" class="button customize-theme"><?php 
        _e('Customize');
        ?>
</button>
				</h3>
...
"></div>
        ...
        if (count($this->controls) > 4) {
            ...
            ?>
						...
						<input type="text" id="themes-filter" placeholder="<?php 
            esc_attr_e('Search installed themes&hellip;');
            ?>
" />
					</label></p>
				<?php 
