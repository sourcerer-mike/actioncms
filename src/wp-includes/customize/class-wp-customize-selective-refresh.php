...
class WP_Customize_Selective_Refresh
{
    ...
    public function export_preview_data()
    {
        ...
        $exports = array('partials' => $partials, 'renderQueryVar' => self::RENDER_QUERY_VAR, 'l10n' => array('shiftClickToEdit' => __('Shift-click to edit this element.'), 'badDocumentWrite' => sprintf(__('%s is forbidden'), 'document.write()')));
        // Export data to JS.
