...
class WP_Customize_Nav_Menu_Item_Setting extends WP_Customize_Setting
{
     ...
     */
    public $default = array('object_id' => 0, 'object' => '', 'menu_item_parent' => 0, 'position' => 0, 'type' => 'custom', 'title' => '', 'url' => '', 'target' => '', 'attr_title' => '', 'description' => '', 'classes' => '', 'xfn' => '', 'status' => 'publish', 'original_title' => '', 'nav_menu_term_id' => 0, '_invalid' => false);
    /**
     * Default transport.
     *
     * @since 4.3.0
    ...
    public function filter_wp_get_nav_menu_items($items, $menu, $args)
    {
        ...
        $should_remove = false === $this_item || true === $this_item['_invalid'] || $this->original_nav_menu_term_id === $menu->term_id && $current_nav_menu_term_id !== $this->original_nav_menu_term_id;
        if ($should_remove) {
    ...
    public function amend_customize_save_response($data)
    {
        ...
        $data['nav_menu_item_updates'][] = array('post_id' => $this->post_id, 'previous_post_id' => $this->previous_post_id, 'error' => $this->update_error ? $this->update_error->get_error_code() : null, 'status' => $this->update_status);
        return $data;
    }
}