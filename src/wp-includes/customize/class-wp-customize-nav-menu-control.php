...
class WP_Customize_Nav_Menu_Control extends WP_Customize_Control
{
    ...
    {
        ?>
		<button type="button" class="button-secondary add-new-menu-item" aria-label="<?php 
...
" aria-describedby="reorder-items-desc-{{ data.menu_id }}">
		...
		<ul class="menu-settings">
			...
			<li class="customize-control customize-control-checkbox assigned-menu-location">
				<label>
					<input type="checkbox" data-menu-id="{{ data.menu_id }}" data-location-id="<?php 
                echo esc_attr($location);
                ?>
" class="menu-location" /> <?php 
                echo $description;
                ?>
