...
class WP_Site_Query
{
    ...
    {
        $this->query_var_defaults = array('fields' => '', 'ID' => '', 'site__in' => '', 'site__not_in' => '', 'number' => 100, 'offset' => '', 'no_found_rows' => true, 'orderby' => 'id', 'order' => 'ASC', 'network_id' => 0, 'network__in' => '', 'network__not_in' => '', 'domain' => '', 'domain__in' => '', 'domain__not_in' => '', 'path' => '', 'path__in' => '', 'path__not_in' => '', 'public' => null, 'archived' => null, 'mature' => null, 'spam' => null, 'deleted' => null, 'search' => '', 'search_columns' => array(), 'count' => false, 'date_query' => null, 'update_site_cache' => true);
        if (!empty($query)) {
            $this->query($query);
        }
    }
    ...
    public function get_sites()
    {
        ...
        if (false === $cache_value) {
            ...
            $cache_value = array('site_ids' => $site_ids, 'found_sites' => $this->found_sites);
