...
class getid3_ogg extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        switch ($info['audio']['dataformat']) {
            ...
            case 'opus':
                $filedata = $this->fread($info['ogg']['pageheader'][$oggpageinfo['page_seqno']]['page_length']);
                $info['ogg']['pageheader'][$oggpageinfo['page_seqno']]['stream_type'] = substr($filedata, 0, 8);
    ...
    public function ParseVorbisPageHeader(&$filedata, &$filedataoffset, &$oggpageinfo)
    {
        ...
        $filedataoffset += 1;
        $info['ogg']['pageheader'][$oggpageinfo['page_seqno']]['stream_type'] = substr($filedata, $filedataoffset, 6);
        // hard-coded to 'vorbis'
        $filedataoffset += 6;
        ...
        $filedataoffset += 4;
        $info['ogg']['blocksize_small'] = pow(2, getid3_lib::LittleEndian2Int(substr($filedata, $filedataoffset, 1)) & 0xf);
        $info['ogg']['blocksize_large'] = pow(2, (getid3_lib::LittleEndian2Int(substr($filedata, $filedataoffset, 1)) & 0xf0) >> 4);
        $info['ogg']['stop_bit'] = getid3_lib::LittleEndian2Int(substr($filedata, $filedataoffset, 1));
    ...
    public function ParseOpusPageHeader(&$filedata, &$filedataoffset, &$oggpageinfo)
    {
        ...
        $info['audio']['bitrate_mode'] = 'vbr';
        $info['audio']['lossless'] = false;
        $info['ogg']['pageheader']['opus']['opus_magic'] = substr($filedata, $filedataoffset, 8);
    ...
    public function ParseOggPageHeader()
    {
        ...
        $oggheader['page_start_offset'] = $this->ftell();
        ...
        $filedataoffset += 1;
        $oggheader['flags']['fresh'] = (bool) ($oggheader['flags_raw'] & 0x1);
        // fresh packet
        $oggheader['flags']['bos'] = (bool) ($oggheader['flags_raw'] & 0x2);
        // first page of logical bitstream (bos)
        $oggheader['flags']['eos'] = (bool) ($oggheader['flags_raw'] & 0x4);
