...
class getid3_ac3 extends getid3_handler
{
    ...
    {
        static $sampleRateCodeLookup = array(0 => 48000, 1 => 44100, 2 => 32000, 3 => 'reserved');
    ...
    public static function centerMixLevelLookup($cmixlev)
    {
        ...
        if (empty($centerMixLevelLookup)) {
            $centerMixLevelLookup = array(0 => pow(2, -3.0 / 6), 1 => pow(2, -4.5 / 6), 2 => pow(2, -6.0 / 6), 3 => 'reserved');
        }
    ...
    {
        $lookup = array('ch1' => (bool) ($acmod == 0), 'ch2' => (bool) ($acmod == 0), 'left' => (bool) ($acmod > 1), 'right' => (bool) ($acmod > 1), 'center' => (bool) ($acmod & 0x1), 'surround_mono' => false, 'surround_left' => false, 'surround_right' => false, 'lfe' => $lfeon);
        switch ($acmod) {
            case 4:
            case 5:
