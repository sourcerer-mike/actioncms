...
class getid3_flv extends getid3_handler
{
    ...
    {
        static $lookup = array(0 => 'Linear PCM, platform endian', 1 => 'ADPCM', 2 => 'mp3', 3 => 'Linear PCM, little endian', 4 => 'Nellymoser 16kHz mono', 5 => 'Nellymoser 8kHz mono', 6 => 'Nellymoser', 7 => 'G.711A-law logarithmic PCM', 8 => 'G.711 mu-law logarithmic PCM', 9 => 'reserved', 10 => 'AAC', 11 => 'Speex', 12 => false, 13 => false, 14 => 'mp3 8kHz', 15 => 'Device-specific sound');
...
class AMFReader
{
    ...
    public function readObject()
    {
        ...
        if ($key == '' && $this->stream->peekByte() == 0x9) {
            // Consume byte
