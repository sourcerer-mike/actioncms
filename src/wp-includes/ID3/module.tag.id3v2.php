...
class getid3_id3v2 extends getid3_handler
{
        ...
        if ($sizeofframes > 0) {
            ...
            if (!empty($thisfile_id3v2_flags['exthead'])) {
                ...
                if ($id3v2_majorversion == 3) {
                    ...
                    $extended_header_offset += 4;
                    $thisfile_id3v2['exthead']['flag_bytes'] = getid3_lib::BigEndian2Int(substr($framedata, $extended_header_offset, 1));
                    // should always be 1
                    ...
                    if ($thisfile_id3v2['exthead']['flags']['update']) {
                        $ext_header_chunk_length = getid3_lib::BigEndian2Int(substr($framedata, $extended_header_offset, 1));
                        // should be 0
                        $extended_header_offset += 1;
                    }
                    if ($thisfile_id3v2['exthead']['flags']['crc']) {
                    ...
                    if ($thisfile_id3v2['exthead']['flags']['restrictions']) {
                        ...
                        $thisfile_id3v2['exthead']['flags']['restrictions']['imgenc'] = ($restrictions_raw & 0x4) >> 2;
                        // s - Image encoding restrictions
                        $thisfile_id3v2['exthead']['flags']['restrictions']['imgsize'] = ($restrictions_raw & 0x3) >> 0;
    ...
    {
        return str_replace("ÿ ", "ÿ", $data);
    }
    public function LookupExtendedHeaderRestrictionsTagSizeLimits($index)
    {
        static $LookupExtendedHeaderRestrictionsTagSizeLimits = array(0x0 => 'No more than 128 frames and 1 MB total tag size', 0x1 => 'No more than 64 frames and 128 KB total tag size', 0x2 => 'No more than 32 frames and 40 KB total tag size', 0x3 => 'No more than 32 frames and 4 KB total tag size');
    ...
    {
        static $LookupExtendedHeaderRestrictionsTextEncodings = array(0x0 => 'No restrictions', 0x1 => 'Strings are only encoded with ISO-8859-1 or UTF-8');
    ...
    {
        static $LookupExtendedHeaderRestrictionsTextFieldSize = array(0x0 => 'No restrictions', 0x1 => 'No string is longer than 1024 characters', 0x2 => 'No string is longer than 128 characters', 0x3 => 'No string is longer than 30 characters');
    ...
    {
        static $LookupExtendedHeaderRestrictionsImageEncoding = array(0x0 => 'No restrictions', 0x1 => 'Images are encoded only with PNG or JPEG');
    ...
    {
        static $LookupExtendedHeaderRestrictionsImageSizeSize = array(0x0 => 'No restrictions', 0x1 => 'All images are 256x256 pixels or smaller', 0x2 => 'All images are 64x64 pixels or smaller', 0x3 => 'All images are exactly 64x64 pixels, unless required otherwise');
    ...
    public static function ETCOEventLookup($index)
    {
        ...
        static $EventLookup = array(0x0 => 'padding (has no meaning)', 0x1 => 'end of initial silence', 0x2 => 'intro start', 0x3 => 'main part start', 0x4 => 'outro start', 0x5 => 'outro end', 0x6 => 'verse start', 0x7 => 'refrain start', 0x8 => 'interlude start', 0x9 => 'theme start', 0xa => 'variation start', 0xb => 'key change', 0xc => 'time change', 0xd => 'momentary unwanted noise (Snap, Crackle & Pop)', 0xe => 'sustained noise', 0xf => 'sustained noise end', 0x10 => 'intro end', 0x11 => 'main part end', 0x12 => 'verse end', 0x13 => 'refrain end', 0x14 => 'theme end', 0x15 => 'profanity', 0x16 => 'profanity end', 0xfd => 'audio end (start of silence)', 0xfe => 'audio file ends', 0xff => 'one more byte of events follows');
        return isset($EventLookup[$index]) ? $EventLookup[$index] : '';
    }
    public static function SYTLContentTypeLookup($index)
    {
        static $SYTLContentTypeLookup = array(0x0 => 'other', 0x1 => 'lyrics', 0x2 => 'text transcription', 0x3 => 'movement/part name', 0x4 => 'events', 0x5 => 'chord', 0x6 => 'trivia/\'pop up\' information', 0x7 => 'URLs to webpages', 0x8 => 'URLs to images');
        return isset($SYTLContentTypeLookup[$index]) ? $SYTLContentTypeLookup[$index] : '';
    }
    public static function APICPictureTypeLookup($index, $returnarray = false)
    {
        static $APICPictureTypeLookup = array(0x0 => 'Other', 0x1 => '32x32 pixels \'file icon\' (PNG only)', 0x2 => 'Other file icon', 0x3 => 'Cover (front)', 0x4 => 'Cover (back)', 0x5 => 'Leaflet page', 0x6 => 'Media (e.g. label side of CD)', 0x7 => 'Lead artist/lead performer/soloist', 0x8 => 'Artist/performer', 0x9 => 'Conductor', 0xa => 'Band/Orchestra', 0xb => 'Composer', 0xc => 'Lyricist/text writer', 0xd => 'Recording Location', 0xe => 'During recording', 0xf => 'During performance', 0x10 => 'Movie/video screen capture', 0x11 => 'A bright coloured fish', 0x12 => 'Illustration', 0x13 => 'Band/artist logotype', 0x14 => 'Publisher/Studio logotype');
        if ($returnarray) {
    ...
    {
        static $COMRReceivedAsLookup = array(0x0 => 'Other', 0x1 => 'Standard CD album with other songs', 0x2 => 'Compressed audio on CD', 0x3 => 'File over the Internet', 0x4 => 'Stream over the Internet', 0x5 => 'As note sheets', 0x6 => 'As note sheets in a book with other sheets', 0x7 => 'Music on other media', 0x8 => 'Non-musical merchandise');
        return isset($COMRReceivedAsLookup[$index]) ? $COMRReceivedAsLookup[$index] : '';
    }
    public static function RVA2ChannelTypeLookup($index)
    {
        static $RVA2ChannelTypeLookup = array(0x0 => 'Other', 0x1 => 'Master volume', 0x2 => 'Front right', 0x3 => 'Front left', 0x4 => 'Back right', 0x5 => 'Back left', 0x6 => 'Front centre', 0x7 => 'Back centre', 0x8 => 'Subwoofer');
    ...
    public static function TextEncodingTerminatorLookup($encoding)
    {
        ...
        static $TextEncodingTerminatorLookup = array(0 => " ", 1 => "  ", 2 => "  ", 3 => " ", 255 => "  ");
