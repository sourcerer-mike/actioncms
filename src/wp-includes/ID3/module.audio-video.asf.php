...
class getid3_asf extends getid3_handler
{
    ...
    {
        static $lookup = array(0x1 => 'Video Codec', 0x2 => 'Audio Codec', 0xffff => 'Unknown Codec');
    ...
    public static function WMpictureTypeLookup($WMpictureType)
    {
        static $lookup = null;
        if ($lookup === null) {
            $lookup = array(0x3 => 'Front Cover', 0x4 => 'Back Cover', 0x0 => 'User Defined', 0x5 => 'Leaflet Page', 0x6 => 'Media Label', 0x7 => 'Lead Artist', 0x8 => 'Artist', 0x9 => 'Conductor', 0xa => 'Band', 0xb => 'Composer', 0xc => 'Lyricist', 0xd => 'Recording Location', 0xe => 'During Recording', 0xf => 'During Performance', 0x10 => 'Video Screen Capture', 0x12 => 'Illustration', 0x13 => 'Band Logotype', 0x14 => 'Publisher Logotype');
        ...
        while ($objectOffset < strlen($asf_header_extension_object_data)) {
            ...
            switch ($thisObject['guid']) {
                case GETID3_ASF_Extended_Stream_Properties_Object:
                    ...
                    $offset += 4;
                    $thisObject['flags']['reliable'] = (bool) $thisObject['flags_raw'] & 0x1;
                    $thisObject['flags']['seekable'] = (bool) $thisObject['flags_raw'] & 0x2;
                    $thisObject['flags']['no_cleanpoints'] = (bool) $thisObject['flags_raw'] & 0x4;
                    $thisObject['flags']['resend_live_cleanpoints'] = (bool) $thisObject['flags_raw'] & 0x8;
                ...
                case GETID3_ASF_Metadata_Library_Object:
                    ...
                    for ($i = 0; $i < $thisObject['description_records_count']; $i++) {
                        ...
                        $descriptionRecord['data'] = substr($asf_header_extension_object_data, $offset, $descriptionRecord['data_length']);
                        $offset += $descriptionRecord['data_length'];
                        if (preg_match('#^WM/Picture$#', str_replace(" ", '', trim($descriptionRecord['name'])))) {
    ...
    {
        static $lookup = array(0x0 => 'Unicode string', 0x1 => 'BYTE array', 0x2 => 'BOOL', 0x3 => 'DWORD', 0x4 => 'QWORD', 0x5 => 'WORD', 0x6 => 'GUID');
