...
class getid3_quicktime extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        $offset = 0;
        $atomcounter = 0;
        $atom_data_read_buffer_size = $info['php_memory_limit'] ? round($info['php_memory_limit'] / 2) : $this->getid3->option_fread_buffer_size * 1024;
        // allow [default: 32MB] if PHP configured with no memory_limit
    ...
    public function QuicktimeParseContainerAtom($atom_data, $baseoffset, &$atomHierarchy, $ParseAllPossibleAtoms)
    {
        ...
        $subatomoffset = 0;
        $subatomcounter = 0;
        if (strlen($atom_data) == 4 && getid3_lib::BigEndian2Int($atom_data) == 0x0) {
            return false;
        }
    ...
    public function CopyToAppropriateCommentsSection($keyname, $data, $boxname = '')
    {
        ...
        if (empty($handyatomtranslatorarray)) {
            ...
            // iTunes 4.0
            $handyatomtranslatorarray["©" . 'too'] = 'encoder';
            // iTunes 4.0
    ...
    public function NoNullString($nullterminatedstring)
    {
        ...
        if (substr($nullterminatedstring, strlen($nullterminatedstring) - 1, 1) === " ") {
