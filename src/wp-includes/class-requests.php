...
class Requests
{
    ...
    protected static function parse_response($headers, $url, $req_headers, $req_data, $options)
    {
        ...
        $return->protocol_version = (double) $matches[1];
    ...
    {
        if (substr($data, 0, 2) !== "‹" && substr($data, 0, 2) !== "xœ") {
    ...
    public static function compatible_gzinflate($gzData)
    {
        ...
        if (0x8 == $first_nibble && 0 == $first_two_bytes % 0x1f) {
        ...
        if ("PK" == substr($gzData, 0, 4)) {
            ...
            $zip_compressed_on_the_fly = 0x8 == (0x8 & $general_purpose_flag);
