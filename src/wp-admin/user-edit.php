...
<?php 
	...
	<?php 
                ...
                ?>
		<a href="user-new.php" class="page-title-action"><?php 
                echo esc_html_x('Add Existing', 'user');
                ?>
</a>
	<?php 
            }
...
<form id="your-profile" action="<?php 
        echo esc_url(self_admin_url(IS_PROFILE_PAGE ? 'profile.php' : 'user-edit.php'));
        ?>
...
<?php 
	...
	<tr class="user-rich-editing-wrap">
		...
		<td><label for="rich_editing"><input name="rich_editing" type="checkbox" id="rich_editing" value="false" <?php 
...
<td><label for="comment_shortcuts"><input type="checkbox" name="comment_shortcuts" id="comment_shortcuts" value="true" <?php 
 ...
 /> <?php 
            ...
            _e('<a href="https://codex.wordpress.org/Keyboard_Shortcuts" target="_blank">More information</a>');
            ?>
</td>
</tr>
<?php 
...
<table class="form-table">
	<tr class="user-user-login-wrap">
        ...
        ?>
" disabled="disabled" class="regular-text" /> <span class="description"><?php 
