...
?>
	...
	<a href="credits.php" class="nav-tab nav-tab-active"><?php 
_e('Credits');
?>
</a>
...
if (!$credits) {
    ...
    printf(__('WordPress is created by a <a href="%1$s">worldwide team</a> of passionate individuals. <a href="%2$s">Get involved in WordPress</a>.'), 'https://wordpress.org/about/', __('https://make.wordpress.org/'));
    echo '</p>';
    echo '</div>';
