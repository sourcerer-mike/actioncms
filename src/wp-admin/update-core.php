...
<?php 
    foreach ((array) $plugins as $plugin_file => $plugin_data) {
        ...
        $details = sprintf('<a href="%1$s" class="thickbox open-plugin-details-modal" aria-label="%2$s">%3$s</a>', esc_url($details_url), esc_attr(sprintf(__('View %1$s version %2$s details'), $plugin_data->Name, $plugin_data->update->new_version)), sprintf(__('View version %s details.'), $plugin_data->update->new_version));
