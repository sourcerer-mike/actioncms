        ...
        case 'delete-selected':
			...
			<div class="wrap">
                ...
                foreach ($theme_info as $theme) {
                    echo '<li>' . sprintf(_x('%1$s by %2$s', 'theme'), '<strong>' . $theme->display('Name') . '</strong>', '<em>' . $theme->display('Author') . '</em>') . '</li>';
                }
                ?>
					</ul>
				<?php 
                if (1 == $themes_to_delete) {
                    ?>
					<p><?php 
                    _e('Are you sure you wish to delete this theme?');
                    ?>
</p>
				<?php 
                } else {
