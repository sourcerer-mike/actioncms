...
echo esc_attr($current_site->site_name);
?>
" />
				</td>
			</tr>
...
?>
				...
				<td>
					<input name="admin_email" type="email" id="admin_email" aria-describedby="admin-email-desc" class="regular-text" value="<?php 
...
echo esc_attr(implode(" ", (array) get_site_option('illegal_names')));
?>
" size="45" />
...
<?php 
echo esc_textarea(get_site_option('welcome_email'));
?>
</textarea>
...
<?php 
echo esc_textarea(get_site_option('welcome_user_email'));
?>
</textarea>
...
<?php 
echo esc_textarea(get_site_option('first_post'));
?>
</textarea>
...
<?php 
echo esc_textarea(get_site_option('first_page'));
?>
</textarea>
...
<?php 
echo esc_textarea(get_site_option('first_comment'));
?>
</textarea>
...
echo esc_attr(get_site_option('upload_filetypes', 'jpg jpeg png gif'));
?>
" size="45" />
...
?>
				...
				<td>
					<?php 
printf(_x('%s KB', 'File size in kilobytes'), '<input name="fileupload_maxk" type="number" min="0" style="width: 100px" id="fileupload_maxk" aria-describedby="fileupload-maxk-desc" value="' . esc_attr(get_site_option('fileupload_maxk', 300)) . '" />');
?>
