                ...
                switch ($status['status']) {
                    ...
                    case 'newer_installed':
                        if (is_plugin_active($status['file'])) {
                            ...
                            $action_links[] = sprintf('<a href="%1$s" class="button activate-now button-secondary" aria-label="%2$s">%3$s</a>', esc_url($activate_url), esc_attr(sprintf($button_label, $plugin['name'])), $button_text);
                        } else {
