...
class WP_Users_List_Table extends WP_List_Table
{
    ...
    {
        parent::__construct(array('singular' => 'user', 'plural' => 'users', 'screen' => isset($args['screen']) ? $args['screen'] : null));
...
">
    ...
    {
        if (isset($_REQUEST['changeit']) && (!empty($_REQUEST['new_role']) || !empty($_REQUEST['new_role2']))) {
            return 'promote';
        }
