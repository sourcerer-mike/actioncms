...
"><?php 
    ...
    if (!empty($api->rating)) {
        ...
        ?>
			<p aria-hidden="true" class="fyi-description"><?php 
        ...
        foreach ($api->ratings as $key => $ratecount) {
            ...
            ?>
				<div class="counter-container">
						<span class="counter-label"><a href="https://wordpress.org/support/view/plugin-reviews/<?php 
            echo $api->slug;
            ?>
?filter=<?php 
            echo $key;
