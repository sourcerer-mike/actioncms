...
class Language_Pack_Upgrader extends WP_Upgrader
{
    ...
    public function bulk_upgrade($language_updates = array(), $args = array())
    {
        ...
        foreach ($language_updates as $language_update) {
            ...
            $language_updates_results[] = array('language' => $language_update->language, 'type' => $language_update->type, 'slug' => isset($language_update->slug) ? $language_update->slug : 'default', 'version' => $language_update->version);
        }
    ...
    public function check_package($source, $remote_source)
    {
        ...
        if (!$mo || !$po) {
            return new WP_Error('incompatible_archive_pomo', $this->strings['incompatible_archive'], sprintf(__('The language pack is missing either the %1$s or %2$s files.'), '<code>.po</code>', '<code>.mo</code>'));
        }
        return $source;
    }
    /**
