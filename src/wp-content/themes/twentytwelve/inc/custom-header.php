...
{
    $args = array('default-text-color' => '515151', 'default-image' => '', 'height' => 250, 'width' => 960, 'max-width' => 2000, 'flex-height' => true, 'flex-width' => true, 'random-default' => false, 'wp-head-callback' => 'twentytwelve_header_style', 'admin-head-callback' => 'twentytwelve_admin_header_style', 'admin-preview-callback' => 'twentytwelve_admin_header_image');
...
function twentytwelve_admin_header_style()
{
	...
	#headimg img {
		max-width: <?php 
    echo get_theme_support('custom-header', 'max-width');
    ?>
px;
	}
	</style>
