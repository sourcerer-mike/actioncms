...
<div id="page" class="hfeed">
	<header id="branding" role="banner">
			<hgroup>
				<h1 id="site-title"><span><a href="<?php 
...
?>
				<div class="skip-link"><a class="assistive-text" href="#content"><?php 
...
if (!is_singular()) {
    ?>
					<div class="skip-link"><a class="assistive-text" href="#secondary"><?php 
