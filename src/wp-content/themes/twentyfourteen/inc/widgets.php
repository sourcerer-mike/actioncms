...
"></p>
        ...
        ?>
"><?php 
        _e('Number of posts to show:', 'twentyfourteen');
        ?>
</label>
			<input id="<?php 
        echo esc_attr($this->get_field_id('number'));
...
" size="3"></p>
			...
			<p><label for="<?php 
        echo esc_attr($this->get_field_id('format'));
        ?>
"><?php 
        _e('Post format to show:', 'twentyfourteen');
        ?>
</label>
			<select id="<?php 
        echo esc_attr($this->get_field_id('format'));
...
">
        ...
        foreach ($this->formats as $slug) {
            ...
            ?>
"<?php 
            selected($format, $slug);
            ?>
><?php 
            echo esc_html(get_post_format_string($slug));
            ?>
</option>
				<?php 
        }
