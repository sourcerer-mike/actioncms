...
if (have_comments()) {
    ...
    if (get_comment_pages_count() > 1 && get_option('page_comments')) {
        ...
        previous_comments_link(__('&larr; Older Comments', 'twentythirteen'));
        ?>
</div>
			<div class="nav-next"><?php 
        next_comments_link(__('Newer Comments &rarr;', 'twentythirteen'));
        ?>
</div>
    ...
    if (!comments_open() && get_comments_number()) {
        ...
        _e('Comments are closed.', 'twentythirteen');
        ?>
</p>
		<?php 
    }
